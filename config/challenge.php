...
return [
    ...
    ①　【总监2000位（每人500元，总计100万）】<br/>
    <hr><br/>
    	恭喜您成功完成了挑战。根据挑战者的排名顺序，我们将为排名前2000名的挑战者颁发奖励。您将以县级运营中心总监的身份依次获得奖励。<br/>
	如果您决定继续接受挑战，本轮将视为您主动放弃总监本轮奖金，并晋升为四等级身份待遇，即挑战县级子公司总经理。
    "
        ],
        User::COUNTY_MANAGER => [
    ...
    <hr>
    	恭喜您成功完成了挑战。根据挑战者的排名顺序，我们将为排名前200名的挑战者颁发奖励。您将以县级子公司总经理的身份依次获得奖励。<br/>
	如果您决定继续接受挑战，本轮将视为您主动放弃总经理本轮奖金，并晋升为五等级身份待遇，即挑战地级子公司总裁。
    "
        ],
        User::AREA_PRESIDENT => [
    ...
    // 	如果您决定继续接受挑战，本轮将视为您主动放弃总裁本轮奖金，并晋升为六等级身份待遇，即挑战省级巡视执行长。</div>",
            "reject_text" => "您已选择放弃晋级挑战，本轮您将享受总裁身份待遇，本轮依照挑战者排序为前20个挑战者发放奖励。",
            "success_text" => "<div>（一）【总裁身份】经营权授权<br/>
    ...
    <hr>
    <div>	恭喜您成功完成了挑战。根据挑战者的排名顺序，我们将为排名前20名的挑战者颁发奖励。您将以地级子公司总裁的身份依次获得奖励。<br>
	如果您决定继续接受挑战，本轮将视为您主动放弃总裁本轮奖金，并晋升为六等级身份待遇，即挑战省级巡视执行长。</div>
    "
        ],
        User::PROVINCE_CEO => [
            ...
            "success_text" => "（一）【董事身份】经营权授权规则<br/>
    ...
    ②　总裁20位（每人5万元，总计100万元）<br/>
    ③　总经理200位（每人5000元，总计100万） <br>
    <hr>
    	恭喜您成功完成了挑战。根据挑战者的排名顺序，我们将为排名前2位的挑战者颁发奖励。您将以省级巡视执行长的身份依次获得奖励。
    "
        ],
    ]
];
